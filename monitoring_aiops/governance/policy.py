...
Rules are loaded from ``~/.monitoring-aiops/rules.yaml`` with hot-reload on file change.
"""
...
_log = logging.getLogger("monitoring-aiops.policy")
...
class PolicyEngine:
    ...
    def check_allowed(
        ...
        *,
        ...
        if os.environ.get("MONITORING_POLICY_DISABLED") == "1":
            ...
            if not self._rules and risk_level in ("high", "critical"):
                return TierDecision(
                    ...
                    reason=(
                        ...
                        "require a named approver (MONITORING_AUDIT_APPROVED_BY) by "
