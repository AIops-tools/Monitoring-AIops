"""Environment and connectivity diagnostics for Monitoring AIops."""

from __future__ import annotations

from rich.console import Console

from monitoring_aiops.config import CONFIG_FILE, ENV_FILE, load_config
from monitoring_aiops.secretstore import SECRETS_FILE, check_permissions, has_store
...
def run_doctor(skip_auth: bool = False) -> int:
    ...
    if not CONFIG_FILE.exists():
        ...
        _console.print("[yellow]  Run 'monitoring-aiops init' to set up your first target.[/]")
        return 1
    ...
    if has_store():
        ...
        _console.print(
            ...
            f"'monitoring-aiops secret migrate'.[/]"
        )
    else:
        _console.print(
            "[yellow]! No secret store yet. Run 'monitoring-aiops init' to set up "
