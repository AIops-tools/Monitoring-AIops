...
DEFAULT_RULES_YAML = """\
# monitoring-aiops policy rules — hot-reloaded on change (no restart needed).
...
risk_tiers:
  - name: high-risk-requires-approver
    ...
    reason: >-
      ...
      MONITORING_AUDIT_APPROVED_BY (and MONITORING_AUDIT_RATIONALE) before the call.

# deny:
#   - name: no-prod-node-removal
#     operations: ["remove_*", "unmanage_*"]
#     environments: ["production"]
#     reason: "Node removal/unmanage in production goes through change management."
