# Release notes — monitoring-aiops 0.6.0
...
- The SWIS legacy-port fallback (17778) now fires only on a connection failure, not a read timeout — a slow-but-healthy 17774 server is no longer misdiagnosed onto the deprecated port.
